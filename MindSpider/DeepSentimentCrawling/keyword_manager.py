...
class KeywordManager:
    ...
    def _get_default_keywords(self) -> List[str]:
        """获取默认关键词列表（高速公路舆情监测专用）"""
        return [
            # 核心监测对象
            "广州交投", "广州高速公路", "广州交通集团",
            "海珠湾隧道",
            # 高速路段
            "广河高速", "增从高速", "北三环高速", "从埔高速", "增天高速",
            "机场高速", "机场第二高速", "花莞高速", "广佛肇高速",
            "广台高速", "新化快速", "大广高速",
            # 收费相关
            "高速公路收费", "收费员", "收费标准", "ETC",
            # 行业事件
    ...
    def _filter_keywords_by_platform(self, keywords: List[str], platform: str) -> List[str]:
        ...
        platform_preferences = {
            'xhs': ['交通', '高速', '收费', '隧道', '出行', '通勤', '生活'],
            'dy': ['交通', '高速', '事故', '新闻', '社会', '生活', '出行'],
            'ks': ['交通', '高速', '生活', '新闻', '社会', '出行'],
            'bili': ['交通', '高速', '新闻', '社会', '科普', '出行'],
            'wb': ['交通', '高速', '新闻', '社会', '热点', '广州', '事故'],
            'tieba': ['交通', '高速', '广州', '讨论', '生活'],
            'zhihu': ['交通', '高速', '政策', '经济', '社会', '思考']
        }
